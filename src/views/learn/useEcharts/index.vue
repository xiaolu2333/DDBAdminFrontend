<template>
  <div class="echarts-box">
    ...
    <div id="chart-3" style="width: 1200px; height: 400px"></div>
    <div id="chart-4" style="width: 1200px; height: 400px"></div>
  </div>
</template>
...
async function init() {
  await getLineChartData()
      .then((response) => {
        ...
        state.ordinaryData = response.data.data
        initCharts();
      })
}
